    ...
    <div className="min-h-screen pt-24 md:pt-32 pb-16">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="glass-card p-8 md:p-10 space-y-8">
          {[
            { title: '1. Data Collection', content: 'QuickShare24 does not collect personal data. We do not require accounts, emails, or any form of registration. The only data stored is the content you explicitly choose to share (messages, code, files) along with metadata like creation time and expiry time.' },
            ...
            { title: '3. Cookies & Tracking', content: 'QuickShare24 does not use cookies, analytics, or tracking scripts. Your recent shares list is stored only in your browser\'s local storage and never sent to any server.' },
            ...
            { title: '6. Third-Party Services', content: 'QuickShare24 uses Firebase (by Google) for data storage and file hosting. Please refer to Google\'s privacy policy for information about how Firebase handles data.' },
